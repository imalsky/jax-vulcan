...
gj436 = np.genfromtxt(
    "sflux-GJ436.txt", names=["lambda", "flux"], dtype=None, skip_header=1
)
gj876 = np.genfromtxt(
    "sflux-GJ876.txt", names=["lambda", "flux"], dtype=None, skip_header=1
)
gj551 = np.genfromtxt(
    "sflux-GJ551.txt", names=["lambda", "flux"], dtype=None, skip_header=1
)
gj1214 = np.genfromtxt(
    "sflux-GJ1214.txt", names=["lambda", "flux"], dtype=None, skip_header=1
)

sun = np.genfromtxt(
    "VPL_solar.txt", names=["lambda", "flux"], dtype=None, skip_header=1
)
