...
sl_angle = 83 / 180.0 * 3.14159  # 83 deg (Tsai 2023)
f_diurnal = 1.0
scat_sp = ["H2", "He"]
T_cross_sp = []
...
trun_min = 1e2
runtime = 1.0e22
# Wall-clock backstop (end_case=4). Master's SNCHO per-step cost is
# ~0.25 s × ~3000 steps ≈ 750 s; 3600 s gives comfortable margin.
wall_clock_max = 3600.0
dt_min = 1.0e-14
dt_max = runtime * 1e-5
dt_var_max = 2.0
dt_var_min = 0.5
